(function(angular) {
    ...
    angular.module('FileManagerApp').service('apiMiddleware', ['$window', 'fileManagerConfig', 'apiHandler', 
        ...
        ApiMiddleware.prototype.initial = function(folder) {
             return this.apiHandler.initial(fileManagerConfig.serverUrl+  fileManagerConfig.initUrl, folder);
        };
        ...
        ApiMiddleware.prototype.list = function(path, customDeferredHandler) {
            return this.apiHandler.list(fileManagerConfig.serverUrl+  fileManagerConfig.listUrl, this.getPath(path), customDeferredHandler);
        };

        ApiMiddleware.prototype.copy = function(files, path) {
            var items = this.getFileList(files);
            return this.apiHandler.copy(fileManagerConfig.serverUrl+  fileManagerConfig.copyUrl, items, this.getPath(path));
        };

        ApiMiddleware.prototype.move = function(files, path) {
            var items = this.getFileList(files);
            return this.apiHandler.move(fileManagerConfig.serverUrl+  fileManagerConfig.moveUrl, items, this.getPath(path));
        };

        ApiMiddleware.prototype.remove = function(files) {
            var items = this.getFileList(files);
            return this.apiHandler.remove(fileManagerConfig.serverUrl+  fileManagerConfig.removeUrl, items);
        };
        ...
        ApiMiddleware.prototype.upload = function(files, path) {
            ...
            return this.apiHandler.upload(fileManagerConfig.serverUrl+  fileManagerConfig.uploadUrl, destination, files);
        };
        ...
        ApiMiddleware.prototype.rename = function(item) {
            ...
            return this.apiHandler.rename(fileManagerConfig.serverUrl+ fileManagerConfig.renameUrl, itemPath, newPath);
        };
        ...
        ApiMiddleware.prototype.download = function(item, forceNewWindow) {
            ...
            return this.apiHandler.download(
                fileManagerConfig.serverUrl+ fileManagerConfig.downloadFileUrl, 
                itemPath,
                toFilename,
        ...
        ApiMiddleware.prototype.downloadMultiple = function(files, forceNewWindow) {
            ...
            return this.apiHandler.downloadMultiple(
                fileManagerConfig.serverUrl+fileManagerConfig.downloadMultipleUrl, 
                items, 
                toFilename, 
                fileManagerConfig.downloadFilesByAjax,
                forceNewWindow
        ...
        ApiMiddleware.prototype.createFolder = function(item) {
            ...
            return this.apiHandler.createFolder(fileManagerConfig.serverUrl+ fileManagerConfig.createFolderUrl, path);
        };
